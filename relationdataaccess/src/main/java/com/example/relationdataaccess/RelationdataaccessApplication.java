package com.example.relationdataaccess;
...
public class RelationdataaccessApplication implements CommandLineRunner {
    private static final Logger log = LoggerFactory.getLogger(RelationdataaccessApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(RelationdataaccessApplication.class, args);
    }
